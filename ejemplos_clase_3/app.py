...
def pulsaciones():
    try:
        ...
        inicio = offset
        fin = offset + limit
        data = base_de_datos[inicio:fin] # aqui tendriamos que abrir la base de datos si la tuvieramos
        ...
        return render_template('tabla.html', data=data) # aqui le pasamos la informacion a "tabla.html" para que lo muestre en el explorador
    except:
        return jsonify({'trace': traceback.format_exc()})
