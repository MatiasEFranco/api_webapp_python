...
def registro():
    ...
    if request.method == 'POST':
        try:
            ...
            if(nombre is None or pulsos is None or pulsos.isdigit() is False): # aqui validamaos que no sea 0 y que sea un digito el valor ingresado
            ...
            return redirect(url_for('pulsaciones')) # aqui redireccionamos a un endpoint de pulsaciones
        except:
            return jsonify({'trace': traceback.format_exc()})
